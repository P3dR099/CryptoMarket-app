...
export default function FullWidthTabs(props) {
    ...
    return (
        <div className={!matchesMax ? classes.root2 : classes.root}>
            ...
            <TabPanel style={{ margin: !matchesMin ? '0px 0px 0px -26px' : '0px 0px 0px 30px' }} value={value} index={1} dir={theme.direction}>
                <GraphCoin value={value} {...props} />
            </TabPanel>
            <TabPanel style={{ margin: !matchesMin ? '0px 0px 0px -26px' : '0px 0px 0px 30px' }} value={value} index={0} dir={theme.direction}>
                <GraphCoin value={value} {...props} />
            </TabPanel>
            <TabPanel style={{ margin: !matchesMin ? '0px 0px 0px -26px' : '0px 0px 0px 30px' }} value={value} index={2} dir={theme.direction}>
                <GraphCoin value={value} {...props} />
            </TabPanel>
        </div>
    );
