        ...
        <div>
            ...
            <CarouselArrowPrev
                ...
                style={{
                    ...
                    background: 'transparent', right: -40, top: '17rem',
                    left: '-1.5rem', width: matches ? 50 : 40,
    ...
    return (
        <CarouselArrowNext
            ...
            style={{
                ...
                height: matches ? 30 : 28, paddingTop: 2.5, top: '17rem',
                left: matches ? '2.5rem' : '1.5rem', border: '1px solid #1cb5e0'
            }}
            onClick={onClick}
