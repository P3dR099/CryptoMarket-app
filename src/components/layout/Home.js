    ...
    return (
        <>
            <Container style={{ maxWidth: 2850, padding: 0 }}>
                <Container style={{ backgroundImage: 'linear-gradient(166deg, rgb(77, 168, 218) 58%, rgb(244, 244, 244) calc(84% + -7px))', height: !matches ? 1200 : 770, padding: 'inherit', maxWidth: 'inherit' }}>
                    <div id="kid">
