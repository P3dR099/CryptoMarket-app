...
export default function DataTable(props) {
    ...
    return (
        <>
            <Container style={{ backgroundImage: 'linear-gradient(166deg, rgb(24 61 200) 58%, rgb(244, 244, 244) calc(84% + -7px))', maxWidth: 1980 }}>
                <div style={{ height: 1200, width: '100%' }} className={classes.root} >

                    <Container style={{ display: "flex", justifyContent: "flex-end", margin: "0px 0px 13px 0px" }}>
                        <ControlledOpenSelect style={{ transform: 'translateY(100)' }} {...props} />
                        <Modal allColumns={columns} setColumns={setColumns} handleRows={handleRows} stateCols={stateCols} setStateCols={setStateCols} {...props} />
                    </Container>
                    <div style={{ marginTop: 115, height: 1015 }}>
...
function ControlledOpenSelect(props) {
    ...
    return (
        <Container>
            <FormControl style={{ width: "65px", marginRight: 10, transform: 'translateY(122px)' }}>
