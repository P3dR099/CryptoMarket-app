...
const CardCrypto = (props) => {
    ...
    return (
        ...
        <Container style={{ padding: matches ? '20px 20px' : '20px 5px', marginTop: 0, maxWidth: '100%', backgroundImage: 'linear-gradient(166deg, rgb(24 61 200) 58%, rgb(244, 244, 244) calc(84% + -7px))', height: '100%', position: 'inherit' }}>
            <Container style={{ padding: '0px 0px 0px 0px', margin: 7 }}>
