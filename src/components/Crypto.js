        ...
        if (matchesDown) {
            return (
                <Grid container spacing={3} style={{ display: 'inherit', whiteSpace: 'pre', justifyContent: 'flex-end', marginTop: 0 }}>
                    <span className={coinInfo.CHANGEPCT24HOUR < 0 ? classBottom.red : classBottom.green} style={{ width: 40, height: 12, fontSize: 9, marginTop: !matches ? 17 : 33, placeItems: 'center', padding: '3px 11px 4px 3px', marginLeft: 15, marginRight: 3 }}>
