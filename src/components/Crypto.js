        ...
        if (matchesDown) {
            return (
                <Grid container spacing={3} style={{ display: 'inherit', whiteSpace: 'pre', justifyContent: 'flex-end', marginTop: 0 }}>
                    <span className={coinInfo.CHANGEPCT24HOUR < 0 ? classBottom.red : classBottom.green} style={{ width: 40, height: 15, fontSize: 10, marginTop: !matches ? 14.5 : 33, placeItems: 'center', padding: '3px 11px 4px 3px', marginLeft: 15 }}>
